...
function PinnedBeat() {
  ...
  return (
    <div ref={trackRef} className="relative h-[280vh]">
      <div className="sticky top-0 flex h-svh flex-col overflow-hidden bg-background px-5 pt-[max(5.25rem,calc(env(safe-area-inset-top)+4.25rem))] pb-[max(1rem,env(safe-area-inset-bottom))]">
        ...
        >
          <motion.span
            style={{ x: markX }}
            className="block whitespace-nowrap text-[11vw] font-medium leading-none tracking-tighter text-foreground/6 md:text-[18vw] md:text-foreground/8.5"
          >
            DEEPFRACT
          </motion.span>
        </div>
        ...
        <motion.div
          ...
          className="relative z-2 mx-auto w-full max-w-120 shrink-0"
        >
